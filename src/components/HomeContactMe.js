    ...
    return (
        <div className="bg-gray-200 p-10">
            ...
            <div className="container flex justify-center mx-auto">
                {/* card */}
                <div data-aos="fade-right" className="block items-center p-4 bg-white border-2 border-gray-200 rounded-3xl shadow-sm w-3/5 my-8 justify-center text-center">
